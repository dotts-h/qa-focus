...
| [0025](0025-epic-live-verify-the-autonomous-loop-end-to-end-across-surfaces.md) | Epic: live-verify the autonomous loop end-to-end across surfaces | closed | medium | — | adr:0005,0011; regression:5 |
...
| [0027](0027-surface-aware-authored-specs-codifier-emits-an-electron-executing-spec-electron-launch-not-just-web.md) | Surface-aware authored specs — codifier emits an Electron-executing spec (_electron.launch), not just web | closed | medium | 0025 | adr:0005,0011; dep:0026 |
